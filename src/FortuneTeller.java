...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	FortuneTeller() throws Exception {
		...
		fortuneTellerImage = ImageIO.read(getClass().getResource("rld fortuneteller.JPG"));
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "zeee zeeecteeet location is neeear zeee bottom");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			JOptionPane.showInputDialog("Give me a ?");
			// 9. Find a spooky sound and put it in your default package (freesound.org)
			AudioClip sound = JApplet.newAudioClip(getClass().getResource("lala.wav"));
			// 10. Play the sound
			sound.play();
